...
function forecastMetric() {
  ...
  let apiUrlForecast = `https://api.openweathermap.org/data/2.5/weather?q=${city}&appid=${apiKeyForecast}&units=metric&lang=uk`;
...
function getForecastMetric(coordinates) {
  let unit = "metric";
  let apiKeyForecast = "3fdc8cfbf2d6fa0116c9ae92d3df4f79";
  let apiUrlForecast = `https://api.openweathermap.org/data/2.5/onecall?lat=${coordinates.lat}&lon=${coordinates.lon}&appid=${apiKeyForecast}&units=${unit}&lang=uk`;
...
function searchCity(event) {
  ...
  let apiUrl = `https://api.openweathermap.org/data/2.5/weather?q=${searchInput.value}&appid=${apiKey}&units=metric&lang=uk`;
...
let apiUrlStart = `https://api.openweathermap.org/data/2.5/weather?q=${start}&appid=${apiKeyStart}&units=metric&lang=uk`;
...
function showPosition(position) {
  ...
  let apiKey = "3fdc8cfbf2d6fa0116c9ae92d3df4f79";
  let apiUrl = `https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${lon}&appid=${apiKey}&units=metric&lang=uk`;
  axios.get(apiUrl).then(showTemperature);
}
